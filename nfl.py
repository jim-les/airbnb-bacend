...
class NFL:
    ...
    async def current_nfl_matches(self, url, date):
        ...
        while True:
            try:
                ...
                driver.implicitly_wait(20) # Wait up to 10 seconds
                ...
                status_elements = soup.find_all('div', class_='dvkfVt')
                ...
                #         print()
                    ...
                    print("NFL Games not found. Retrying...")
